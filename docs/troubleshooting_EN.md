Language: **English** | [中文](troubleshooting.md)

# Runtime troubleshooting

> Common on-board issues and decision paths. Platform architecture: [architecture-and-runtime_EN.md](architecture-and-runtime_EN.md); adapters: [adapters_EN.md](adapters_EN.md).
...
- See [architecture-and-runtime_EN.md](architecture-and-runtime_EN.md) §1, §5 and [llm-model-coordinator_EN.md](llm-model-coordinator_EN.md) §5–§6.

### Truncated LLM replies

- Check `max_new_tokens` and `max_context_len`; long replies may be truncated → [llm-model-coordinator_EN.md](llm-model-coordinator_EN.md).

### TTS

- Voice UX and TTS debug: [tts-melotts_EN.md](tts-melotts_EN.md) §13.
