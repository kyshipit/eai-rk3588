Language: **English** | [中文](llm-model-coordinator.md)
...
Adapter files: [adapters_EN.md](adapters_EN.md) § LLM.
...
- Acceptance and debug: [tts-melotts_EN.md](tts-melotts_EN.md).
...
Product strings are Chinese on the terminal (same as [llm-model-coordinator.md](llm-model-coordinator.md) §5 and §9 below).
...
| Doc | Use |
|-----|-----|
| [architecture-and-runtime_EN.md](architecture-and-runtime_EN.md) | Platform overview, load order, continue development |
| [tts-melotts_EN.md](tts-melotts_EN.md) | TTS design and acceptance |
| [adapters_EN.md](adapters_EN.md) § LLM | LLM adapter cheat sheet |
| [troubleshooting_EN.md](troubleshooting_EN.md) | Zero boxes, wrong paths, exit/crash; TTS details in TTS doc |
| [README_EN.md](../README_EN.md) | Documentation index |
